...
var cubeRotation = function(audio){
    ...
    var render = function () {
      ...
      // cube.rotation.y += 0.01;
      // cube.rotation.z -= 0.01;
      cube.rotation.x += (volume / 270) + 0.001;
      cube.rotation.y -= (volume / 290) + 0.001;
      cube.rotation.z += (volume / 270) + 0.001;
      cube.scale.x = volume * 0.3;
      cube.scale.y = volume * 0.3;
      cube.scale.z = volume * 0.3;

      cube2.rotation.x -= (volume / 270) + 0.001;
      cube2.rotation.y += (volume / 290) + 0.001;
      cube2.rotation.z += (volume / 270) + 0.001;
      cube2.scale.x = volume * 0.3;
      cube2.scale.y = volume * 0.3;
      cube2.scale.z = volume * 0.3;
